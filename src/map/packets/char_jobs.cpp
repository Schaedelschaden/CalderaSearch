...
CCharJobsPacket::CCharJobsPacket(CCharEntity * PChar)
{
    ...
    ref<uint16>(0x62) = PChar->m_StatsDebilitation;  // Bit field. Underestimation of physical characteristics, the characteristic turns red and a red arrow appears next to it.
