...
public:
	...
	int32 getAmmoQuantity(lua_State*);       // Returns the quantity of an item equipped in the player's ammunition slot
...
/*     int32 doWildCard(lua_State*); */
    ...
    int32 useWeaponskill(lua_State*);       // Forces a mob, trust, or PC to use a weaponskill
