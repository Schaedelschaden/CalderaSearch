...
-- Dumping data for table tpzdb.char_look: 64 rows
...
INSERT INTO `char_look` (`charid`, `face`, `race`, `size`, `head`, `body`, `hands`, `legs`, `feet`, `main`, `sub`, `ranged`) VALUES
	(1, 10, 7, 2, 71, 71, 71, 71, 71, 21, 0, 0),
	...
	(67, 15, 1, 2, 0, 8, 8, 8, 8, 21, 0, 0),
	(68, 15, 1, 2, 0, 8, 8, 8, 8, 0, 0, 0),
	(69, 10, 4, 2, 0, 8, 8, 8, 8, 0, 0, 0);
