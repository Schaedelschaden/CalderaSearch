...
-- Dumping structure for table tpzdb.transport
...
-- Dumping data for table tpzdb.transport: 17 rows
...
INSERT INTO `transport` (`id`, `name`, `transport`, `door`, `dock_x`, `dock_y`, `dock_z`, `dock_rot`, `boundary`, `anim_arrive`, `anim_depart`, `time_offset`, `time_interval`, `time_anim_arrive`, `time_waiting`, `time_anim_depart`, `zone`) VALUES
	...
	(9, 'Selbina-Mhaura_Boat', 17793088, 17793087, 9.294, 0.000, -69.775, 0, 485, 18, 19, 382, 480, 18, 80, 17, 220),
	(10, 'Mhaura-Selbina_Boat', 17797182, 17797181, -0.516, 0.026, -8.409, 0, 493, 18, 19, 382, 480, 18, 80, 17, 221),
	(11, 'Mhaura-Whitegate_Boat', 17797182, 17797181, -0.516, 0.026, -8.409, 0, 493, 18, 19, 142, 480, 18, 80, 17, 46),
