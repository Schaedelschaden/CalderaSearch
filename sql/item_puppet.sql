...
INSERT INTO `item_puppet` (`itemid`, `name`, `slot`, `element`) VALUES
	(8193, 'harlequin_head', 1, 574899268),
	(8194, 'valoredge_x-900_head', 1, 606360613),
	(8195, 'sharpshot_z-500_head', 1, 608445733),
	(8196, 'stormwaker_y-700_head', 1, 1112687698),
	(8197, 'soulsoother_c-1000_head', 1, 626148434),
	(8198, 'spiritreaver_m-400_head', 1, 1381123154),
	(8224, 'harlequin_frame', 2, 1431655765),
	(8225, 'valoredge_x-900_frame', 2, 1163224390),
	(8226, 'sharpshot_z-500_frame', 2, 1163286085),
	(8227, 'stormwaker_y-700_frame', 2, 1700090980),
	(8449, 'strobe', 3, 1),
