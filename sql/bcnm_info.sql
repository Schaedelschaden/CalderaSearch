...
-- Dumping data for table tpzdb.bcnm_info: 247 rows
...
INSERT INTO `bcnm_info` (`bcnmId`, `zoneId`, `name`, `fastestName`, `fastestPartySize`, `fastestTime`, `timeLimit`, `levelCap`, `partySize`, `lootDropId`, `rules`, `isMission`) VALUES
	(0, 139, 'rank_2_mission', 'Zahabi', 1, 1800, 1800, 0, 6, 0, 5, 1),
	...
	(11, 139, 'horns_of_war', 'Pearl', 3, 1418, 1800, 0, 18, 11, 15, 0),
	(12, 139, 'under_observation', 'nobody', 0, 900, 900, 0, 3, 12, 15, 0),
	(13, 139, 'eye_of_the_tiger', 'Jukebox', 6, 249, 1800, 0, 6, 13, 15, 0),
	(14, 139, 'shots_in_the_dark', 'nobody', 0, 900, 900, 0, 3, 14, 15, 0),
	(15, 139, 'double_dragonian', 'Pheliont', 1, 85, 1800, 0, 6, 15, 15, 0),
	...
	(75, 144, 'grove_guardians', 'nobody', 0, 1800, 1800, 0, 6, 75, 15, 0),
	(76, 144, 'hills_are_alive', 'Pheliont', 3, 1351, 1800, 0, 18, 76, 15, 0),
	(77, 144, 'royal_jelly', 'nobody', 0, 900, 900, 0, 3, 77, 15, 0),
	(78, 144, 'final_bout', 'nobody', 0, 180, 180, 0, 3, 78, 15, 0),
	(79, 144, 'up_in_arms', 'nobody', 0, 1800, 1800, 0, 6, 79, 15, 0),
	(80, 144, 'copycat', 'nobody', 0, 1800, 1800, 0, 6, 80, 15, 0),
	(81, 144, 'operation_desert_swarm', 'Stupified', 6, 270, 1800, 0, 6, 81, 15, 0),
	(82, 144, 'prehistoric_pigeons', 'Baucant', 5, 164, 1800, 0, 6, 82, 15, 0),
	...
	(108, 146, 'royal_succession', 'Jukebox', 3, 448, 1800, 0, 6, 108, 15, 0),
	...
	(160, 165, 'shadow_lord_battle', 'Zydred', 4, 373, 1800, 0, 6, 0, 5, 1),
	...
	(193, 168, 'legion_xi_comitatensis', 'Acebandage', 3, 122, 1800, 0, 6, 193, 15, 0),
	...
	(198, 168, 'eye_of_the_storm', 'Jakefirebrand', 6, 339, 1800, 0, 6, 198, 15, 0),
	...
	(224, 170, 'moonlit_path', 'Jakefiretwo', 6, 1004, 1800, 0, 6, 0, 5, 0),
	...
	(256, 179, 'return_to_delkfutts_tower', 'Terafied', 5, 478, 1800, 0, 6, 0, 5, 0),
	...
	(290, 180, 'ark_angels_3', 'Pheliont', 2, 327, 1800, 0, 6, 0, 5, 0),
	(291, 180, 'ark_angels_4', 'Bean', 6, 599, 1800, 0, 6, 0, 5, 0),
	(292, 180, 'ark_angels_5', 'Benji', 6, 396, 1800, 0, 6, 0, 5, 0),
	(293, 180, 'divine_might', 'nobody', 0, 1800, 1800, 0, 18, 0, 5, 1),
	...
	(448, 202, 'trial_by_lightning', 'Pheliont', 3, 218, 1800, 0, 6, 0, 5, 0),
	...
	(520, 206, 'demolition_squad', 'nobody', 0, 1800, 1800, 0, 6, 520, 15, 0),
	(521, 206, 'die_by_the_sword', 'nobody', 0, 1800, 1800, 0, 6, 521, 15, 0),
	(522, 206, 'let_sleeping_dogs_die', 'Jukebox', 3, 97, 1800, 0, 6, 522, 15, 0),
	(523, 206, 'brothers_d_aurphe', 'Terafied', 6, 219, 1800, 0, 6, 523, 15, 0),
	...
	(544, 207, 'trial_by_fire', 'Pheliont', 3, 244, 1800, 0, 6, 0, 5, 0),
	...
	(608, 211, 'trial_by_water', 'Pearl', 3, 247, 1800, 0, 6, 0, 5, 0),
	...
	(640, 6, 'flames_for_the_dead', 'Pheliont', 3, 400, 1800, 0, 6, 0, 5, 0),
	...
	(643, 6, 'brothers', 'Pettest', 1, 58, 1800, 0, 18, 643, 15, 0),
	(644, 6, 'holy_cow', 'nobody', 0, 1800, 1800, 0, 18, 644, 15, 0),
	(672, 8, 'head_wind', 'nobody', 0, 1800, 1800, 0, 6, 0, 5, 1),
	...
	(706, 10, 'waking_dreams', 'Lightx', 6, 1180, 1800, 0, 18, 0, 5, 0),
	...
	(961, 31, 'savage', 'nobody', 0, 1800, 1800, 0, 6, 0, 5, 1),
	...
	(992, 32, 'one_to_be_feared', 'Ericnuke', 6, 1699, 2700, 0, 6, 0, 5, 1),
	(993, 32, 'warriors_path', 'Jane', 6, 280, 1800, 0, 6, 0, 5, 1),
	...
	(1088, 57, 'call_to_arms', 'Khalum', 1, 40, 1800, 0, 6, 1088, 15, 0),
	(1089, 57, 'compliments_to_the_chef', 'Khalum', 1, 38, 1800, 0, 6, 1089, 15, 0),
	...
	(1120, 64, 'tough_nut_to_crack', 'Khalum', 0, 303, 1800, 0, 6, 1120, 15, 0),
	...
	(1153, 67, 'shadows_of_the_mind', 'Khalum', 1, 47, 1800, 0, 6, 1153, 15, 0),
	...
	(1291, 38, 'sw_apollyon', 'nobody', 0, 3600, 3600, 0, 18, 0, 7, 0),
	(1292, 38, 'ne_apollyon', 'nobody', 0, 1800, 3600, 0, 18, 0, 7, 0),
	(1293, 38, 'se_apollyon', 'nobody', 0, 3600, 3600, 0, 18, 0, 7, 0),
	...
	(1756, 57, 'legacy_of_the_lost_htbf', 'Khalum', 1, 38, 1800, 0, 6, 0, 5, 0);
