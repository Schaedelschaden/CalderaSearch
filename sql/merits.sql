...
-- Dumping structure for table tpzdb.merits
...
-- Dumping data for table tpzdb.merits: 296 rows
...
INSERT INTO `merits` (`meritid`, `name`, `upgrade`, `value`, `jobs`, `upgradeid`, `catagoryid`) VALUES
	...
	(1540, 'reverse_flourish_effect', 5, 30, 262144, 6, 23),
	...
	(1664, 'shijin_spiral', 1, 3, 131074, 8, 25),
	(1666, 'exenterator', 1, 3, 333617, 8, 25),
	(1668, 'requiescat', 1, 3, 113361, 8, 25),
	(1670, 'resolution', 1, 3, 193, 8, 25),
	(1672, 'ruinator', 1, 3, 1409, 8, 25),
	(1674, 'upheaval', 1, 3, 129, 8, 25),
	(1676, 'entropy', 1, 3, 385, 8, 25),
	(1678, 'stardiver', 1, 3, 10241, 8, 25),
	(1680, 'blade_shun', 1, 3, 4096, 8, 25),
	(1682, 'tachi_shoha', 1, 3, 2048, 8, 25),
	(1684, 'realmrazor', 1, 3, 573519, 8, 25),
	(1686, 'shattersoul', 1, 3, 549455, 8, 25),
	(1688, 'apex_arrow', 1, 3, 3072, 8, 25),
	(1690, 'last_stand', 1, 3, 66592, 8, 25),
	(1728, 'full_circle_effect', 5, 5, 1048576, 6, 26),
	...
	(2498, 'diabolic_eye', 5, 20, 128, 7, 38),
	...
	(2690, 'flashy_shot', 5, 5, 1024, 7, 41),
	...
	(3396, 'curative_recantation', 5, 5, 1048576, 7, 52),
	(3398, 'primordial_zeal', 5, 10, 1048576, 7, 52),
	(1792, 'rune_enhancement_effect', 5, 2, 2097152, 6, 27),
	(1794, 'vallation_effect', 5, 1, 2097152, 6, 27),
	(1796, 'lunge_effect', 5, 3, 2097152, 6, 27),
	(1798, 'pflug_effect', 5, 1, 2097152, 6, 27),
	(1800, 'gambit_effect', 5, 10, 2097152, 6, 27),
