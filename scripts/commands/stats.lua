...
function onTrigger(player)
	...
	player:PrintToPlayer(string.format("  Blood Pact Delay: [-%i]  Blood Pact Delay II: [-%i]  Damage Limit Trait: [%i]  Damage Limit Gear: [%i%%]", BPDelay, BPDelayII, DLTrait, DLGear),tpz.msg.channel.SYSTEM_3)
