...
function onTrigger(player)
	...
	local kcTawaret = player:getCharVar("KillCounter_Tawaret")
	...
	player:PrintToPlayer(string.format("  Jeuno - Cherufe: [%i]  Tawaret: [%i]  Yatagarasu: [%i]  Agathos: [%i]  Goji: [%i]  Gugalanna: [%i]", kcCherufe, kcTawaret, kcYatagarasu, kcAgathos, kcGoji, kcGugalanna),tpz.msg.channel.SYSTEM_3)
end