...
function onTrigger(player)
	if (player:hasPet() == true) then
		...
		player:PrintToPlayer(string.format("  HP: [%i/%i]  ATT: [%i]  MATT: [%i]  DEF: [%i]  MDEF: [%i]  ACC: [%i]  MACC: [%i]  RACC: [%i]  EVA: [%i]  MEVA: [%i]", PetCurrentHP, PetMaxHP, PetATT, PetMATT, PetDEF, PetMDEF, PetACC, PetMACC, PetRACC, PetEVA, PetMEVA),tpz.msg.channel.SYSTEM_3)
