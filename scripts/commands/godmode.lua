...
function onTrigger(player)
    if (player:getCharVar("GodMode") == 0) then
        ...
        player:addMod(tpz.mod.STR, 300)
        player:addMod(tpz.mod.DEX, 300)
        player:addMod(tpz.mod.VIT, 300)
        player:addMod(tpz.mod.AGI, 300)
        player:addMod(tpz.mod.INT, 300)
        player:addMod(tpz.mod.MND, 300)
        player:addMod(tpz.mod.CHR, 300)
        ...
        -- Remove bonus mods..
        player:delMod(tpz.mod.STR, 300)
        player:delMod(tpz.mod.DEX, 300)
        player:delMod(tpz.mod.VIT, 300)
        player:delMod(tpz.mod.AGI, 300)
        player:delMod(tpz.mod.INT, 300)
        player:delMod(tpz.mod.MND, 300)
        player:delMod(tpz.mod.CHR, 300)
