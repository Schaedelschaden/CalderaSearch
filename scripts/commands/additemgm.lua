---------------------------------------------------------------------------------------------------
-- func: !additemgm <itemId> <quantity> <aug1> <v1> <aug2> <v2> <aug3> <v3> <aug4> <v4> <trial>
...
function error(player, msg)
    ...
    player:PrintToPlayer("!additemgm <itemId> {quantity} {aug1} {v1} {aug2} {v2} {aug3} {v3} {aug4} {v4} {trial}")
end
