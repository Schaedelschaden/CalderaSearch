...
zones[tpz.zone.YHOATOR_JUNGLE] =
{
    text =
    {
        ...
        ALREADY_OBTAINED_TELE       = 7651,  -- You already possess the gate crystal for this telepoint.
        LOGGING_IS_POSSIBLE_HERE    = 7664,  -- Logging is possible here if you have <item>.
        HARVESTING_IS_POSSIBLE_HERE = 7671,  -- Harvesting is possible here if you have <item>.
        TREE_CHECK                  = 7678,  -- The hole in this tree is filled with a sweet-smelling liquid.
        TREE_FULL                   = 7679,  -- Your wine barrel is already full.
        WATER_HOLE                  = 7682,  -- There is an Opo-opo drinking well here. It seems they feast here, too.
        FAINT_CRY                   = 7683,  -- You hear the cry of a famished Opo-opo!
        PAMAMAS                     = 7686,  -- You might be able to draw an Opo-opo here if you had more pamamas.
