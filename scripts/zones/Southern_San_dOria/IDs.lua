...
zones[tpz.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
		...
		RAMINEL_DELIVERY               = 8103, -- Here's your delivery! (Incorrect: 8097)
        RAMINEL_DELIVERIES             = 8105, -- Sorry, I have deliveries to make! (Incorrect: 8099)
		...
		LUSIANE_THANK                  = 8886, -- Thank you! My snoring will express gratitude mere words cannot! Here's something for you in return. (Incorrect: 8880)
