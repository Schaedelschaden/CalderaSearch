...
zones[tpz.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        RAMINEL_DELIVERIES             = 8107, -- Sorry, I have deliveries to make! (Incorrect: 8099)
        RAMINEL_DELIVERY               = 8108, -- Here's your delivery! (Incorrect: 8097)
        LUSIANE_THANK                  = 8109, -- Thank you! My snoring will express gratitude mere words cannot! Here's something for you in return. (Incorrect: 8880)
