...
function onMobSpawn(mob) -- When mob spawns (either forced or time)
    ...
    mob:setMod(tpz.mod.DISPELRES, 30) -- Resistance to Dispel?
	...
	mob:addMod(tpz.mod.ATT, math.random(500, 600)) -- Attack Stat (Compare to DEF)
	...
	mob:addMod(tpz.mod.DEF, math.random(100, 200)) -- Defense (Compart to ATT)
