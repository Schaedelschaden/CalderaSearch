...
function onMobDeath(mob, player, isKiller) -- When mob is killed
    ...
    if player:getCharVar("Escha_Umdhlebi_KI") == 0 or player:getCharVar("Escha_Umdhlebi_KI") == nil then
        player:setCharVar("Escha_Kamohoalii_KI", 1)
    elseif player:getCharVar("Escha_Umdhlebi_KI") == 1 then
        ...
        player:setCharVar("Escha_Kamohoalii_KI", 0)
    end
