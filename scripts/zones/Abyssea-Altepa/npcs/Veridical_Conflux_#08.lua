...
function onTrigger(player, npc)
    ...
    player:startEvent(2139, 6553600, 3932248, 3670068, 2621500, 255, 7, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 41, 100, 2621500, 255, 7, 1, cruor)
	elseif (option == 131073 and cruor >= 100) then -- Veridical Conflux #02
		player:updateEvent(1, 41, 100, 2621500, 255, 7, 1, cruor)
