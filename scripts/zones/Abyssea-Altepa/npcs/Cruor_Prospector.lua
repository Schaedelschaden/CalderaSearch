...
function onEventFinish(player, csid, option)
    ...
    local ItemID = 0
    local Quantity = 1
--	printf("Aby-Altepa Cruor_Prospector.cpp onEventFinish CSID: [%i]  OPTION: [%i]\n", csid, option)
	
	-- Item Exchanges - Page 1
    if option == 65537 then -- Ravager's Mufflers
		Price = 5000
		ItemID = 12048
    elseif option == 131073 then -- Tantra Gloves
        Price = 5000
        ItemID = 12049
    elseif option == 196609 then -- Orison Mitts
        Price = 5000
        ItemID = 12050
    elseif option == 262145 then -- Geotia Gloves
        Price = 5000
        ItemID = 12051
    elseif option == 327681 then -- Estoqueur's Gantherots
        Price = 5000
        ItemID = 12052
    elseif option == 393217 then -- Raider's Armlets
        Price = 5000
        ItemID = 12053
	elseif option == 458753 then -- Utilis Shield
        Price = 5000
        ItemID = 16191
	elseif option == 524289 then -- Pyf Harp
        Price = 5000
        ItemID = 18573
	end
    ...
    if option == 17235969 then -- 1x Forbidden Key
        Price = 500
        ItemID = 2490
    elseif option == 84344833 then -- 5x Forbidden Key
        Price = 2500
        ItemID = 2490
        Quantity = 5
    elseif option == 168230913 then -- 10x Forbidden Key
        Price = 5000
        ItemID = 2490
        Quantity = 10
    elseif option == 503775233 then -- 30x Forbidden Key
        Price = 15000
        ItemID = 2490
        Quantity = 30
    elseif option == 839319553 then -- 50x Forbidden Key
        Price = 25000
        ItemID = 2490
        Quantity = 50
		
	-- Item Exchanges - Page 2
    elseif option == 720897 then -- Shadow Throne
        Price = 2000000
        ItemID = 6410
	...
	-- Key Item Exchanges
    elseif option == 65539 then -- Map of Abyssea - Altepa
        if not player:hasKeyItem(tpz.ki.MAP_OF_ABYSSEA_ALTEPA) then
            player:messageSpecial(ID.text.KEYITEM_OBTAINED, tpz.ki.MAP_OF_ABYSSEA_ALTEPA)
            player:addKeyItem(tpz.ki.MAP_OF_ABYSSEA_ALTEPA)
