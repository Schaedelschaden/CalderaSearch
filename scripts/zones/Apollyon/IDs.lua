...
zones[tpz.zone.APOLLYON] =
{
    text =
    {
        ...
        WIPE                    = 7361, -- All party members in Limbus have fallen in battle. Exiting in <number> [minute/minutes].
        CHIP_TRADE              = 7368, -- The light in the <item> has grown dim.
        TIME_EXTENDED           = 7370, -- Your time in Limbus has been extended <number> [minute/minutes].
        TIME_LEFT               = 7371, -- You have <number> [minute/minutes] left in Limbus.
