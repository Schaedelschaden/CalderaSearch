				...
				v.entity:addListener("ABILITY_STATE_EXIT", "PLAYER_USE_2HRS", function(player, ability)
					...
					for v = 1, 13 do
						if (abilityID == playerTwoHours[v] and player:hasRecast(tpz.recast.ABILITY, 0) and avUsedTwoHour == v and os.time() - avTwoHourTime <= 15) then
							-- printf("Warder_of_Courage.lua 2hr Listener [%s] TRIGGERED 2HR: [%i]", player:getName(), playerTwoHours[v])
					...
					if (abilityID == 61 and player:hasRecast(tpz.recast.ABILITY, 163) and avUsedTwoHour == 14 and os.time() - avTwoHourTime <= 15) then
						-- printf("Warder_of_Courage.lua 2hr Listener [%s] TRIGGERED 2HR: [%i]", player:getName(), abilityID)
						SetServerVariable(cantUse2Hr[12], 1)
						SetServerVariable(cantUse2Hr[13], 1)
						SetServerVariable(cantUse2Hr[14], 1)
						
						for i = ID.mob.Warder_of_Courage + 1, ID.mob.Warder_of_Courage + 3 do
							DespawnMob(i)
						end
					end
				end)
...
--		printf("Warder_of_Courage.lua onMobFight 2HR PICKED: [%i]  2HRS LOCKED: [%i]", pick2Hr, #twoHoursLocked)
...
--		printf("Warder_of_Courage.lua onMobFight RAGE")
	end
end
