...
function onEventFinish(player, csid, option)
    ...
    local ItemID = 0
    local Quantity = 1
--	printf("Aby-Vunkerl Cruor_Prospector.cpp onEventFinish CSID: [%i]  OPTION: [%i]\n", csid, option)
	
	-- Item Exchanges - Page 1
    if option == 65537 then -- Unkai Kabuto
        Price = 5000
        ItemID = 12019
    elseif option == 131073 then -- Iga Zukin
        Price = 5000
        ItemID = 12020
    elseif option == 196609 then -- Lancer's Mezail
        Price = 5000
        ItemID = 12021
    elseif option == 262145 then -- Caller's Horn
        Price = 5000
        ItemID = 12022
    elseif option == 327681 then -- Mavi Kavuk
        Price = 5000
        ItemID = 12023
    elseif option == 393217 then -- Navarch's Tricorne
        Price = 5000
        ItemID = 12024
    elseif option == 458753 then -- Cirque Cappello
        Price = 5000
        ItemID = 12025
    elseif option == 524289 then -- Charis Tiara
        Price = 5000
        ItemID = 12026
    elseif option == 589825 then -- Savant's Bonnet
        Price = 5000
        ItemID = 12027
	end
    ...
    elseif option == 983041 then -- Shadow Throne
        Price = 2000000
        ItemID = 6410
    ...
    elseif option == 65539 then -- Map of Abyssea - Vunkerl
        if not player:hasKeyItem(tpz.ki.MAP_OF_ABYSSEA_VUNKERL) then
            player:messageSpecial(ID.text.KEYITEM_OBTAINED, tpz.ki.MAP_OF_ABYSSEA_VUNKERL)
            player:addKeyItem(tpz.ki.MAP_OF_ABYSSEA_VUNKERL)
