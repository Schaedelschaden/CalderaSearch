...
function onTrigger(player, npc)
    ...
    player:startEvent(2136, 2359296, 1703972, 1572884, 2228254, 511, 4, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 41, 100, 2228254, 511, 4, 1, cruor)
	...
	elseif (option == 393217 and cruor >= 24) then -- Veridical Conflux #06
		player:updateEvent(1, 41, 100, 2228254, 511, 4, 1, cruor)
		player:delCurrency("cruor", 24)
	elseif (option == 458753 and cruor >= 30) then -- Veridical Conflux #07
		player:updateEvent(1, 41, 100, 2228254, 511, 4, 1, cruor)
	...
	elseif (option == 589825) then -- Veridical Conflux #00
		player:updateEvent(1, 41, 100, 2228254, 255, 0, 1, cruor)
	end
end
