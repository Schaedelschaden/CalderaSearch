...
function onTrigger(player, npc)
    ...
    player:startEvent(2139, 1572864, 1703964, 2621474, 1310758, 511, 7, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 41, 100, 1310758, 511, 7, 1, cruor)
	elseif (option == 131073 and cruor >= 24) then -- Veridical Conflux #02
		player:updateEvent(1, 41, 100, 1310758, 511, 7, 1, cruor)
		player:delCurrency("cruor", 24)
	elseif (option == 196609 and cruor >= 28) then -- Veridical Conflux #03
		player:updateEvent(1, 41, 100, 1310758, 511, 7, 1, cruor)
		player:delCurrency("cruor", 28)
	elseif (option == 262145 and cruor >= 26) then -- Veridical Conflux #04
		player:updateEvent(1, 41, 100, 1310758, 511, 7, 1, cruor)
		player:delCurrency("cruor", 26)
	elseif (option == 327681 and cruor >= 34) then -- Veridical Conflux #05
		player:updateEvent(1, 41, 100, 1310758, 511, 7, 1, cruor)
		player:delCurrency("cruor", 34)
	elseif (option == 393217 and cruor >= 40) then -- Veridical Conflux #06
		player:updateEvent(1, 41, 100, 1310758, 511, 7, 1, cruor)
		player:delCurrency("cruor", 40)
	elseif (option == 458753 and cruor >= 38) then -- Veridical Conflux #07
		player:updateEvent(1, 41, 100, 1310758, 511, 7, 1, cruor)
		player:delCurrency("cruor", 38)
	elseif (option == 589825) then -- Veridical Conflux #00
		player:updateEvent(1, 41, 100, 1310758, 255, 0, 1, cruor)
	end
end
