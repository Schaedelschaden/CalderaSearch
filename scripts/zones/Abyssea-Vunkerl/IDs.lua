...
zones[tpz.zone.ABYSSEA_VUNKERL] =
{
    ...
    mob =
    {
		ON_DEATH_KI =
		{
			[17666516] = {reward = tpz.ki.MALODOROUS_MARID_FUR},       -- Ayravata
			[17666515] = {reward = tpz.ki.CHIPPED_IMPS_OLIFANT},       -- Div-e Sipid
			[17666490] = {reward = tpz.ki.DECAYED_DVERGR_TOOTH},       -- Dvalinn
			[17666514] = {reward = tpz.ki.SHIMMERING_PUGIL_SCALE},     -- Hrosshvalur
			[17666489] = {reward = tpz.ki.GLOSSY_SEA_MONK_SUCKER},     -- Iku-Turso
			[17666491] = {reward = tpz.ki.PULSATING_SOULFLAYER_BEARD}, -- Kadraeth the Hatespawn
			[17666487] = {reward = tpz.ki.INGROWN_TAURUS_NAIL},        -- Khalkotaur
			[17666513] = {reward = tpz.ki.IMBRUED_VAMPYR_FANG},        -- Lord Varney
			[17666488] = {reward = tpz.ki.OSSIFIED_GARGOUILLE_HAND},   -- Quasimodo
			[17666492] = {reward = tpz.ki.WARPED_SMILODON_CHOKER},     -- Rakshas
		}
    },
    npc =
    {
