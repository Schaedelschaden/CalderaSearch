...
function onTrigger(player, npc)
    ...
    player:startEvent(2136, 3538944, 3670050, 3145756, 2621474, 511, 4, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 0, 0, 2621474, 511, 4, 1, cruor)
	elseif (option == 131073 and cruor >= 54) then -- Veridical Conflux #02
		player:updateEvent(1, 0, 0, 2621474, 511, 4, 1, cruor)
		player:delCurrency("cruor", 54)
	elseif (option == 196609 and cruor >= 34) then -- Veridical Conflux #03
		player:updateEvent(1, 0, 0, 2621474, 511, 4, 1, cruor)
	...
	elseif (option == 589825) then -- Veridical Conflux #00
		player:updateEvent(1, 0, 0, 2621474, 255, 4, 1, cruor)
	end
end
