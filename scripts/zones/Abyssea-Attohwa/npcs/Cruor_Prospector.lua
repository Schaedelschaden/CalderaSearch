...
function onEventFinish(player, csid, option)
    ...
    local ItemID = 0
    local Quantity = 1
--	printf("Aby-Attohwa Cruor_Prospector.cpp onEventFinish CSID: [%i]  OPTION: [%i]\n", csid, option)
	
	-- Item Exchanges - Page 1
    if option == 65537 then -- Ravager's Mask
        Price = 5000
        ItemID = 12008
    elseif option == 131073 then -- Tantra Crown
        Price = 5000
        ItemID = 12009
    elseif option == 196609 then -- Orison Cap
        Price = 5000
        ItemID = 12010
    elseif option == 262145 then -- Geotia Petasos
        Price = 5000
        ItemID = 12011
    elseif option == 327681 then -- Estoqueur's Chappel
        Price = 5000
        ItemID = 12012
    elseif option == 393217 then -- Raider's Bonnet
        Price = 5000
        ItemID = 12013
	end
    ...
    elseif option == 839319553 then -- 50x Forbidden Key
        ...
        ItemID = 2490
        Quantity = 50
    elseif option == 589825 then -- Shadow Throne
        Price = 2000000
        ItemID = 6410
	...
	-- Key Item Exchanges
    elseif option == 65539 then -- Map of Abyssea - Attowha
        if not player:hasKeyItem(tpz.ki.MAP_OF_ABYSSEA_ATTOHWA) then
            player:messageSpecial(ID.text.KEYITEM_OBTAINED, tpz.ki.MAP_OF_ABYSSEA_ATTOHWA)
            player:addKeyItem(tpz.ki.MAP_OF_ABYSSEA_ATTOHWA)
