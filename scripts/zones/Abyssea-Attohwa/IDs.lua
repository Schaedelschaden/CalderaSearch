...
zones[tpz.zone.ABYSSEA_ATTOHWA] =
{
    ...
    mob =
    {
		ON_DEATH_KI =
		{
			[17658287] = {reward = tpz.ki.SHRIVELED_HECTEYES_STALK},  -- Amun
			[17658262] = {reward = tpz.ki.BULBOUS_CRAWLER_COCOON},    -- Blazing Eruca
			[17658266] = {reward = tpz.ki.WRITHING_GHOST_FINGER},     -- Drekavac
			[17658264] = {reward = tpz.ki.BLOTCHED_DOOMED_TONGUE},    -- Gaizkin
			[17658288] = {reward = tpz.ki.RUSTED_HOUND_COLLAR},       -- Gieremund
			[17658261] = {reward = tpz.ki.VENOMOUS_WAMOURA_FEELER},   -- Granite Borer
			[17658265] = {reward = tpz.ki.CRACKED_SKELETON_CLAVICLE}, -- Kharon
			[17658263] = {reward = tpz.ki.MUCID_WORM_SEGMENT},        -- Pallid Percy
			[17658267] = {reward = tpz.ki.HOLLOW_DRAGON_EYE},         -- Svarbhanu
			[17658286] = {reward = tpz.ki.DISTENDED_CHIGOE_ABDOMEN},  -- Tunga
		}
    },
    npc =
    {
