...
--	mob:setMod(tpz.mod.MOVE, 80)
	...
	mob:setMod(tpz.mod.PETRIFYRES, 25)
	mob:setMod(tpz.mod.SILENCERES, 50)
	mob:setMod(tpz.mod.ATT, 1800)
	mob:setMod(tpz.mod.MATT, 500)
    mob:setMod(tpz.mod.ACC, 1100)
	mob:setMod(tpz.mod.MACC, 1100)
    mob:setMod(tpz.mod.EVA, 1050)
	mob:setMod(tpz.mod.DEF, 1000)
	mob:setMod(tpz.mod.MEVA, math.random(930, 1170))
