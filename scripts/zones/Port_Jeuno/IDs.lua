...
zones[tpz.zone.PORT_JEUNO] =
{
    text =
    {
        ...
        GAVIN_DIALOG            = 7365, -- This is the counter for the air route to the Outlands. Our airships connect Jeuno with the southeastern island of Elshimo.
        TSOLAG_DIALOG           = 7383, -- This is the departure gate for airship passengers. If you have any questions, please inquire with Guddal.
