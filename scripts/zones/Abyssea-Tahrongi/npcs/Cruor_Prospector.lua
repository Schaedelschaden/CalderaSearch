...
function onEventFinish(player, csid, option)
    ...
    local ItemID = 0
    local Quantity = 1
--	printf("Aby-Tahrongi Cruor_Prospector.cpp onEventFinish CSID: [%i]  OPTION: [%i]\n", csid, option)
    ...
    elseif option == 65539 then -- Map of Abyssea - Tahrongi
        if not player:hasKeyItem(tpz.ki.MAP_OF_ABYSSEA_TAHRONGI) then
            player:messageSpecial(ID.text.KEYITEM_OBTAINED, tpz.ki.MAP_OF_ABYSSEA_TAHRONGI)
            player:addKeyItem(tpz.ki.MAP_OF_ABYSSEA_TAHRONGI)
