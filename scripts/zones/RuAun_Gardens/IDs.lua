...
zones[tpz.zone.RUAUN_GARDENS] =
{
    text =
    {
        ...
        IT_IS_ALREADY_FUNCTIONING  = 7310,  -- It is already functioning.
        CHEST_UNLOCKED             = 7344,  -- You unlock the chest!
        SKY_GOD_OFFSET             = 7361,  -- A strange insignia pointing north is carved into the wall.
		...
		-- = 7586, -- The monster was concealing a treasure chest!
        REGIME_REGISTERED          = 9727,  -- New training regime registered!
        HOMEPOINT_SET              = 11648, -- Home point set!
        COMMON_SENSE_SURVIVAL      = 11668, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        DESPOT_PH =
