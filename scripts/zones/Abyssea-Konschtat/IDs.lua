...
zones[tpz.zone.ABYSSEA_KONSCHTAT] =
{
    ...
    mob =
    {
		ON_DEATH_KI =
		{
			[16838751] = {reward = tpz.ki.FRAGRANT_TREANT_PETAL},    -- Gangly Gean
			[16838855] = {reward = tpz.ki.FETID_RAFFLESIA_STALK},    -- Raskovnik
			[16838913] = {reward = tpz.ki.TURBID_SLIME_OIL},         -- Fistule
			[16838979] = {reward = tpz.ki.TATTERED_HIPPOGRYPH_WING}, -- Alkonost
			[16838993] = {reward = tpz.ki.MUCID_AHRIMAN_EYEBALL},    -- Arimaspi
			[16838946] = {reward = tpz.ki.DECAYING_MORBOL_TOOTH},    -- Clingy Clare
			[16838871] = {reward = tpz.ki.CRACKED_WIVRE_HORN},       -- Keratyrannos
			[16838872] = {reward = tpz.ki.VENOMOUS_PEISTE_CLAW},     -- Kukulkan
			[16839067] = {reward = tpz.ki.TWISTED_TONBERRY_CROWN},   -- Tonberry Lieje
			[16839070] = {reward = tpz.ki.VENOMOUS_PEISTE_CLAW},     -- Kukulkan
			[16839073] = {reward = tpz.ki.VENOMOUS_PEISTE_CLAW},     -- Kukulkan
		}
    },
    npc =
    {
