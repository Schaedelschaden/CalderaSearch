...
function onTrigger(player, npc)
    ...
    player:startEvent(2139, 5242880, 4194384, 3932220, 2621500, 255, 7, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 0, 0, 2621500, 255, 7, 1, cruor)
	elseif (option == 131073 and cruor >= 80) then -- Veridical Conflux #02
		player:updateEvent(1, 0, 0, 2621500, 255, 7, 1, cruor)
		player:delCurrency("cruor", 80)
	elseif (option == 196609 and cruor >= 80) then -- Veridical Conflux #03
		player:updateEvent(1, 0, 0, 2621500, 255, 7, 1, cruor)
		player:delCurrency("cruor", 80)
