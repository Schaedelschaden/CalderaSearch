...
function onTrigger(player, npc)
    ...
    player:startEvent(2135, 3407872, 2621504, 4194352, 4194360, 255, 3, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 0, 0, 4194360, 255, 3, 1, cruor)
	...
	elseif (option == 393217 and cruor >= 64) then -- Veridical Conflux #06
		player:updateEvent(1, 0, 0, 4194360, 255, 3, 1, cruor)
		player:delCurrency("cruor", 64)
