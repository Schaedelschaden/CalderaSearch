...
function onTrigger(player,npc)
    local stock_under_99 =
    {
        ...
        17296,  3,          -- (Throwing) Pebble
        17298,  120,        -- (Ammunition) Tathlum
        17299,  160,        -- (Ammunition) Astragalos
        17290,  5000,       -- (Throwing) Coarse Boomerang
        6299,   3000,       -- (Throwing) Shuriken Pouch
        6297,   4500,       -- (Throwing) Juji Shuriken Pouch
        6302,   15000,      -- (Throwing) Fuma Shuriken Pouch
        6300,   16000,      -- (Throwing) Koga Shuriken Pouch
        6304,   18000,      -- (Throwing) Roppo Shuriken Pouch
        4219,   300,        -- (Ammunition) Stone Arrow Quiver
        4222,   2700,       -- (Ammunition) Horn Arrow Quiver
        4224,   3000,       -- (Ammunition) Demon Arrow Quiver
        5819,   12000,      -- (Ammunition) Antlion Arrow Quiver
        6137,   15000,      -- (Ammunition) Chapuli Arrow Quiver
        4227,   300,        -- (Ammunition) Bronze Bolt Quiver
        ...
        6139,   10000,      -- (Ammunition) Midrium Bolt Quiver
        6141,   11500,      -- (Ammunition) Oxidant Bolt Quiver
        5359,   300,        -- (Ammunition) Bronze Bullet Pouch
        5363,   3000,       -- (Ammunition) Bullet Pouch
        5353,   10000,      -- (Ammunition) Iron Bullet Pouch
        17342,  300,        -- (Ammunition) Cannon Shell
        5823,   10000,      -- (Ammunition) Oberon's Bullet Pouch
