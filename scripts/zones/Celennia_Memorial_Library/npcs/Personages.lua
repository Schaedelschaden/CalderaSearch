...
function onTrigger(player, npc)
    ...
    if (level >= 50) then
        if (job == tpz.job.WAR and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.MNK and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.WHM and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.BLM and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.RDM and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.THF and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.PLD and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.DRK and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.BST and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.BRD and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.RNG and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.SAM and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.NIN and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.DRG and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.SMN and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.BLU and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.COR and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.PUP and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.DNC and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.SCH and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.GEO and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        elseif (job == tpz.job.RUN and level >= 50 and player:getFreeSlotsCount() >= 5) then
        ...
        player:PrintToPlayer(string.format("You can claim a full set of your job's artifact armor from here at level 50."),tpz.msg.channel.SYSTEM_3)
    end
end
