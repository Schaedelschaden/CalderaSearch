...
function onMobFight(mob, target)
    ...
    GetMobByID(16892071):untargetable(false)
    GetMobByID(16892071):SetAutoAttackEnabled(true)    
    GetMobByID(16892071):setUnkillable(false)   
    GetMobByID(16892071):setMod(tpz.mod.ACC, 800) 
    local shifter = math.random(16, 23)
    if os.time() > mob:getLocalVar("shift") then
        GetMobByID(16892071):setModelId(shifter)
        mob:setLocalVar("shift", os.time() + 60)
    end
end
