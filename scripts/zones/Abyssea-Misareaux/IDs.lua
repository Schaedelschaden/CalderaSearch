...
zones[tpz.zone.ABYSSEA_MISAREAUX] =
{
    ...
    mob =
    {
		ON_DEATH_KI =
		{
			[17662494] = {reward = tpz.ki.BLAZING_CLUSTER_SOUL},     -- Abyssic Cluster
			[17662492] = {reward = tpz.ki.BLOODIED_BAT_FUR},         -- Asanbosam
			[17662468] = {reward = tpz.ki.GLISTENING_OROBON_LIVER},  -- Cep-Kamuy
			[17662466] = {reward = tpz.ki.JAGGED_APKALLU_BEAK},      -- Funereal Apkallu
			[17662491] = {reward = tpz.ki.MOLTED_PEISTE_SKIN},       -- Gukumatz
			[17662493] = {reward = tpz.ki.DOFFED_POROGGO_HAT},       -- Heqet
			[17662469] = {reward = tpz.ki.SCALDING_IRONCLAD_SPIKE},  -- Ionclad Observer
			[17662467] = {reward = tpz.ki.CLIPPED_BIRD_WING},        -- Manohra
			[17662464] = {reward = tpz.ki.BLOODSTAINED_BUGARD_FANG}, -- Minax Bugard
			[17662465] = {reward = tpz.ki.GNARLED_LIZARD_NAIL},      -- Sirrush
		}
    },
    npc =
    {
