...
function onTrigger(player, npc)
    ...
    player:startEvent(2137, 2555904, 2359323, 1572893, 3342380, 511, 5, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 0, 0, 3342380, 511, 5, 1, cruor)
	...
	elseif (option == 327681 and cruor >= 29) then -- Veridical Conflux #05
		player:updateEvent(1, 0, 0, 3342380, 511, 5, 1, cruor)
	...
	elseif (option == 589825) then -- Veridical Conflux #00
		player:updateEvent(1, 11, 21, 3342380, 511, 7, 1, cruor)
	end
end
