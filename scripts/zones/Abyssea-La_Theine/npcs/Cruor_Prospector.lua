...
--	printf("Aby-LaTheine Cruor_Prospector.cpp onEventFinish CSID: [%i]  OPTION: [%i]\n", csid, option)
	...
	-- Key Item Exchanges
    elseif option == 65539 then -- Map of Abyssea - La Theine
        if not player:hasKeyItem(tpz.ki.MAP_OF_ABYSSEA_LA_THEINE) then
            player:messageSpecial(ID.text.KEYITEM_OBTAINED, tpz.ki.MAP_OF_ABYSSEA_LA_THEINE)
            player:addKeyItem(tpz.ki.MAP_OF_ABYSSEA_LA_THEINE)
