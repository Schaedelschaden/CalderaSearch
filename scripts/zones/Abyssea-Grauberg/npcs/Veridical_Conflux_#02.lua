...
function onTrigger(player, npc)
    ...
    player:startEvent(2133, 2621440, 3407924, 5242960, 4980812, 255, 1, 1, cruor)
end

function onEventUpdate(player, csid, option)
	local cruor = player:getCurrency("cruor")
	if (option == 65537) then -- Veridical Conflux #01
		player:updateEvent(1, 0, 0, 4980812, 255, 1, 1, cruor)
	...
	elseif (option == 262145 and cruor >= 52) then -- Veridical Conflux #04
		player:updateEvent(1, 0, 0, 4980812, 255, 1, 1, cruor)
		player:delCurrency("cruor", 52)
	elseif (option == 327681 and cruor >= 80) then -- Veridical Conflux #05
		player:updateEvent(1, 0, 0, 4980812, 255, 1, 1, cruor)
	...
	elseif (option == 524289 and cruor >= 76) then -- Veridical Conflux #08
		player:updateEvent(1, 0, 0, 4980812, 255, 1, 1, cruor)
		player:delCurrency("cruor", 76)
	end
end
