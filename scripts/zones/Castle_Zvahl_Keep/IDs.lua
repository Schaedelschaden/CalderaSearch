...
zones[tpz.zone.CASTLE_ZVAHL_KEEP] =
{
    text =
    {
        ...
        ITEMS_ITEMS_LA_LA       = 7240, -- You can hear a strange voice... Items, items, la la la la la
        GOBLIN_SLIPPED_AWAY     = 7246, -- The Goblin slipped away when you were not looking...
