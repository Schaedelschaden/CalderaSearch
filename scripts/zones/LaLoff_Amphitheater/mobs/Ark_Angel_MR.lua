...
local divineMightID = {17514522, 17514530, 17514538}
local aaID = {{17514521, 17514525, 17514526, 17514527},
			  {17514529, 17514533, 17514534, 17514535},
			  {17514537, 17514541, 17514542, 17514543}}
...
function onMobFight(mob, target)
	...
	if (mob:getLocalVar("DROPLIST_SET") == 0) then
		...
		-- printf("Ark_Angel_MR.lua onMobFight BATTLEFIELD ID: [%i]", battlefieldID)
		...
		for i = 1, #aaID[battlefieldArea] do
			if (battlefieldID == 293 and GetMobByID(aaID[battlefieldArea][i]):isDead()) then
				...
				-- printf("Ark_Angel_MR.lua onMobFight DROP LIST COUNTER: [%i]", droplistCounter)
			end
		end
		
		if (droplistCounter >= 4) then
			-- printf("Ark_Angel_MR.lua onMobFight DROP LIST COUNTER >= 4")
			mob:setDropID(3290)
