...
function onMobFight(mob, target) -- When mob is engaged
	...
	local buddy1   = GetMobByID(ID.mob.GIRZORHOR_THE_IMPRUDENT)
	local buddy2   = GetMobByID(ID.mob.WORDORBOR_THE_ARTIFICER)
