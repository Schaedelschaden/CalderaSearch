...
zones[tpz.zone.DYNAMIS_JEUNO] =
{
    text =
    {
        ...
        DYNAMIS_TIME_EXTEND     = 7216, -- Your stay in Dynamis has been extended by <number> minute[/s].
        DYNAMIS_TIME_UPDATE_1   = 7217, -- You will be expelled from Dynamis in <number> [second/minute] (Earth time).
        DYNAMIS_TIME_UPDATE_2   = 7218, -- You will be expelled from Dynamis in <number> [seconds/minutes] (Earth time).
