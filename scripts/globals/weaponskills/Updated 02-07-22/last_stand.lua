...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    ...
    params.str_wsc = 0.0 params.dex_wsc = 0.0 params.vit_wsc = 0.0 params.agi_wsc = 0.85 + (player:getMerit(tpz.merit.LAST_STAND) / 100) params.int_wsc = 0.0 params.mnd_wsc = 0.0 params.chr_wsc = 0.0
