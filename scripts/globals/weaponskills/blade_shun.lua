...
function onUseWeaponSkill(player, target, wsID, tp, primary, action, taChar)
    local params = {}
        ...
        params.str_wsc = 0.0    params.dex_wsc = 0.85 + (player:getMerit(tpz.merit.BLADE_SHUN) / 100) params.vit_wsc = 0.0 params.agi_wsc = 0.0
    ...
    if USE_ADOULIN_WEAPON_SKILL_CHANGES == true then
        params.ftp100  = 1.00 params.ftp200 = 1.00 params.ftp300 = 1.00
        params.dex_wsc = 0.85
		params.atk100  = 1.25 params.atk200 = 1.50 params.atk300 = 2.00
    end
