...
tpz.msg.basic =
{
    ...
    SHADOW_ABSORB          = 31,  -- <numer> of <target>'s shadows absorb the damage and disappear.
	...
	-- = 404, -- <number> status effects are drained from <target>.
	...
	-- = 608, -- <user> uses <ability>. Treasure Hunter effectiveness against <target> increases to <number>.
	...
	-- = 738, -- <user> uses <skill>.
	-- = 739, -- <target> receives <number> magical effect(s).
	...
	-- = 798, -- <user>'s <PUP maneuver> overload chance is <number>%.
	-- = 799, -- <user>'s <PUP maneuver> overload chance is <number>%. <user> is overloaded!
