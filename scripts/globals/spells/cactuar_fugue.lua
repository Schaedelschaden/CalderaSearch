-----------------------------------------
-- Spell: Cactuar Fugue
-- Enhances resistance against weight for party members within area of effect. 
-----------------------------------------
...
function onSpellCast(caster, target, spell)
    ...
    if not (target:addBardSong(caster, tpz.effect.FUGUE, power, 0, duration, caster:getID(), tpz.magic.ele.LIGHT, 1)) then
        spell:setMsg(tpz.msg.basic.MAGIC_NO_EFFECT)
    end

    return tpz.effect.FUGUE
end