...
function onSpellCast(caster, target, spell)
    ...
    target:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 11, 3, duration, tpz.effect.GEO_ACCURACY_DOWN, power, tpz.auraTarget.ENEMIES, tpz.effectFlag.AURA)
