...
function onSpellCast(caster, target, spell)
    ...
    target:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 4, 3, duration, tpz.effect.GEO_DEX_BOOST, power, tpz.auraTarget.ALLIES, tpz.effectFlag.AURA)
