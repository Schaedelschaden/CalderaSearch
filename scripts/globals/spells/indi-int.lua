...
function onSpellCast(caster, target, spell)
    ...
    target:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 1, 3, duration, tpz.effect.GEO_INT_BOOST, power, tpz.auraTarget.ALLIES, tpz.effectFlag.AURA)
