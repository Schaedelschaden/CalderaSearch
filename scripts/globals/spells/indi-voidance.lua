...
function onSpellCast(caster, target, spell)
    ...
    target:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 2, 3, duration, tpz.effect.GEO_EVASION_BOOST, power, tpz.auraTarget.ALLIES, tpz.effectFlag.AURA)
