...
function onSpellCast(caster, target, spell)
    ...
    target:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 13, 3, duration, tpz.effect.GEO_POISON, power, tpz.auraTarget.ENEMIES, tpz.effectFlag.AURA)
