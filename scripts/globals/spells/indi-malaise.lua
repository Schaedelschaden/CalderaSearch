...
function onSpellCast(caster, target, spell)
    ...
    target:addStatusEffectEx(tpz.effect.COLURE_ACTIVE, tpz.effect.COLURE_ACTIVE, 12, 3, duration, tpz.effect.GEO_MAGIC_DEF_DOWN, power, tpz.auraTarget.ENEMIES, tpz.effectFlag.AURA)
