...
local GearSets =  {
             ...
             {id = 74, items = {26920, 26921, 27434, 27259, 27260, 26762, 26763, 27074, 27075, 27433}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ZANSHIN_DOUBLE_DAMAGE, 12, 6, 0}} },    -- 109/119 SAM Reforged Empyrean
             {id = 75, items = {27414, 27413, 27240, 27239, 27055, 27054, 26901, 26900, 26743, 26742}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.EXTRA_KICK_ATTACK, 5, 5, 0}} },         -- 109/119 MNK Reforged Empyrean
             {id = 76, items = {26740, 26741, 27411, 27412, 27238, 27237, 27053, 27052, 26899, 26898}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.DA_DOUBLE_DAMAGE, 12, 6, 0}} },         -- 109/119 WAR Reforged Empyrean
             {id = 77, items = {26750, 26751, 27421, 27422, 27247, 27248, 27063, 27062, 26908, 26909}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.TA_TRIPLE_DAMAGE, 12, 6, 0}} },         -- 109/119 THF Reforged Empyrean
             {id = 78, items = {26918, 26919, 26761, 26760, 27431, 27432, 27257, 27258, 27072, 27073}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.RAPID_SHOT_DOUBLE_DAMAGE, 12, 6, 0}} }, -- 109/119 RNG Reforged Empyrean
             {id = 79, items = {26910, 26911, 26752, 26753, 27424, 27423, 27064, 27065, 27249, 27250}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ABSORB_DMG_CHANCE, 6, 3, 0}} },         -- 109/119 PLD Reforged Empyrean
             {id = 80, items = {26922, 26923, 26764, 26765, 27076, 27077, 27261, 27262, 27435, 27436}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.EXTRA_DUAL_WIELD_ATTACK, 5, 5, 0}} },   -- 109/119 NIN Reforged Empyrean
             {id = 81, items = {27443, 27444, 26772, 26773, 26930, 26931, 27084, 27085, 27269, 27270}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.QUICK_DRAW_TRIPLE_DAMAGE, 12, 6, 0}} }, -- 109/119 COR Reforged Empyrean
             {id = 82, items = {27275, 27276, 27449, 27450, 26778, 26779, 26936, 26937, 27090, 27091}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.GRIMOIRE_INSTANT_CAST, 6, 3, 0}} },     -- 109/119 SCH Reforged Empyrean
             {id = 83, items = {27241, 27242, 27415, 27416, 26744, 26745, 26902, 26903, 27056, 27057}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.BAR_ELEMENT_NULL_CHANCE, 6, 3, 0}} },   -- 109/119 WHM Reforged Empyrean
             ...
             {id = 118, items = {26211, 25569, 25797, 25835, 25886, 25953}, matches = 3, matchType = matchtype.ring_armor, mods = {{tpz.mod.STR, 8, 8, 0}, {tpz.mod.DEX, 8, 8, 0}, {tpz.mod.VIT, 8, 8, 0}} }, -- Flamma Armor Set +2 STR/DEX/VIT +8-32 (Requires Flamma Ring to activate set effect)
             ...
             {id = 133, items = {26191, 23308, 23643, 23241, 23576, 23174, 23509, 23107, 23442, 23040, 23375}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 WAR
             {id = 136, items = {26191, 23309, 23644, 23242, 23577, 23175, 23510, 23108, 23443, 23041, 23376}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 MNK
             {id = 139, items = {26085, 23310, 23645, 23243, 23578, 23176, 23511, 23109, 23444, 23042, 23377}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 WHM
             {id = 142, items = {26085, 23311, 23646, 23244, 23579, 23177, 23512, 23110, 23445, 23043, 23378}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 BLM
             {id = 145, items = {26085, 23312, 23647, 23245, 23580, 23178, 23513, 23111, 23446, 23044, 23379}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 RDM
             {id = 148, items = {26191, 23313, 23648, 23246, 23581, 23179, 23514, 23112, 23447, 23045, 23380}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 THF
             {id = 151, items = {26191, 23314, 23649, 23247, 23582, 23180, 23515, 23113, 23448, 23046, 23381}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 PLD
             {id = 154, items = {26191, 23315, 23650, 23248, 23583, 23181, 23516, 23114, 23449, 23047, 23382}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 DRK
             {id = 157, items = {26191, 23316, 23651, 23249, 23584, 23182, 23517, 23115, 23450, 23048, 23383}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 BST
             {id = 160, items = {26085, 23317, 23652, 23250, 23585, 23183, 23518, 23116, 23451, 23049, 23384}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 BRD
             {id = 163, items = {26191, 23318, 23653, 23251, 23586, 23184, 23519, 23117, 23452, 23050, 23385}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 RNG
             {id = 166, items = {26191, 23319, 23654, 23252, 23587, 23185, 23520, 23118, 23453, 23051, 23386}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 SAM
             {id = 169, items = {26191, 23320, 23655, 23253, 23588, 23186, 23521, 23119, 23454, 23052, 23387}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 NIN
             {id = 172, items = {26191, 23321, 23656, 23254, 23589, 23187, 23522, 23120, 23455, 23053, 23388}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 DRG
             {id = 175, items = {26342, 23322, 23657, 23255, 23590, 23188, 23523, 23121, 23456, 23054, 23389}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 SMN
             {id = 178, items = {26085, 23323, 23658, 23256, 23591, 23189, 23524, 23122, 23457, 23055, 23390}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 BLU
             {id = 181, items = {26191, 23324, 23659, 23257, 23592, 23190, 23525, 23123, 23458, 23056, 23391}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 COR
             {id = 184, items = {26191, 23325, 23660, 23258, 23593, 23191, 23526, 23124, 23459, 23057, 23392}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 PUP
             {id = 187, items = {26191, 23326, 23661, 23259, 23594, 23192, 23527, 23125, 23460, 23058, 23393}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 DNC (M)
             {id = 190, items = {26191, 23327, 23662, 23260, 23595, 23193, 23528, 23126, 23461, 23059, 23394}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 DNC (F)
             {id = 193, items = {26085, 23328, 23663, 23261, 23596, 23194, 23529, 23127, 23462, 23060, 23395}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 SCH
             {id = 196, items = {26085, 23329, 23664, 23262, 23597, 23195, 23530, 23128, 23463, 23061, 23396}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Earring + AF1 119 +2/3 GEO
             {id = 199, items = {26191, 23330, 23665, 23263, 23598, 23196, 23531, 23129, 23464, 23062, 23397}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ACC, 15, 0, 0}, {tpz.mod.RACC, 15, 0, 0}, {tpz.mod.MACC, 15, 0, 0}} }, -- Regal Ring + AF1 119 +2/3 RUN
			 ...
			 {id = 214, items = {26746, 26904, 27058, 27243, 27417, 26747, 26905, 27059, 27244, 27418}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.AUGMENT_CONSERVE_MP, 10, 5, 0}} },        -- 109/119 BLM Reforged Empyrean. Set Bonus: Augments "Conserve MP". Occasionally causes spells which proc Conserve MP to deal between +12.5% ~ +100% damage
			 {id = 215, items = {26748, 26906, 27060, 27245, 27419, 26749, 26907, 27061, 27246, 27420}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.AUGMENT_COMPOSURE, 20, 10, 0}} },         -- 109/119 RDM Reforged Empyrean. Set Bonus: Augments "Composure". Increases the duration of enhancing magic when cast on other people
			 {id = 216, items = {26754, 26912, 27066, 27251, 27425, 26755, 26913, 27067, 27252, 27426}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.OCC_VARIES_ATT_HP, 10, 5, 0}} },          -- 109/119 DRK Reforged Empyrean. Set Bonus: “Attack occasionally varies with HP”. Chance to increase ATK by 50-100% based on HP
			 {id = 217, items = {26756, 26914, 27068, 27253, 27427, 26757, 26915, 27069, 27254, 27428}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.OCC_VARIES_ATT_PET_HP, 10, 5, 0}} },      -- 109/119 BST Reforged Empyrean. Set Bonus: “Attack occasionally varies with pet's HP”. Chance to increase ATK by 50-100% based on pet's HP
			 {id = 218, items = {26758, 26916, 27070, 27255, 27429, 26759, 26917, 27071, 27256, 27430}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.AUGMENT_SONGS, 2, 1, 0}} },               -- 109/119 BRD Reforged Empyrean. Set Bonus: Augments songs. Adds stats or MP based on song element
			 {id = 219, items = {26766, 26924, 27078, 27263, 27437, 26767, 26925, 27079, 27264, 27438}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.OCC_VARIES_ATT_PET_HP, 10, 5, 0}} },      -- 109/119 DRG Reforged Empyrean. Set Bonus: “Attack occasionally varies with wyvern's HP”. Chance to increase ATK by 50-100% based on pet's HP
			 {id = 220, items = {26768, 26926, 27080, 27265, 27439, 26769, 26927, 27081, 27266, 27440}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.AUGMENT_BLOOD_BOON, 10, 5, 0}} },         -- 109/119 SMN Reforged Empyrean. Set Bonus: Augments "Blood Boon". Blood Boon occasionally increases the damage of Blood Pacts by 25% per armor piece
			 {id = 221, items = {26770, 26928, 27082, 27267, 27441, 26771, 26929, 27083, 27268, 27442}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.AUGMENT_AUGMENT_BLUE_MAGIC, 10, 5, 0}} }, -- 109/119 BLU Reforged Empyrean. Set Bonus: Occ. augments blue magic spells. Triples the WSC factor of blue magic spells
			 {id = 222, items = {26774, 26932, 27086, 27271, 27445, 26775, 26933, 27087, 27272, 27446}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.OCC_VARIES_ATT_PET_HP, 10, 5, 0}} },      -- 109/119 PUP Reforged Empyrean. Set Bonus: “Attack occasionally varies with automaton's HP”. Chance to increase ATK by 50-100% based on pet's HP
			 {id = 223, items = {26776, 26934, 27088, 27273, 27447, 26777, 26935, 27089, 27274, 27448}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.SAMBA_DOUBLE_DAMAGE, 10, 5, 0}} },        -- 109/119 DNC Reforged Empyrean. Set Bonus: Augments "Samba". Occasionally doubles damage with Samba up. Adds approximately 1-2% per piece past the first
			 {id = 224, items = {26780, 26938, 27092, 27277, 27451, 26781, 26939, 27093, 27278, 27452}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.GEO_NO_SPELL_MP_DEPLETION, 4, 2, 0}} },   -- 109/119 GEO Reforged Empyrean. Set Bonus: MP occasionally not depleted when using geomancy spells. Adds 2% activation chance per piece
			 {id = 225, items = {26782, 26940, 27094, 27279, 27453, 26783, 26941, 27095, 27280, 27454}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ABSORB_DMG_CHANCE, 6, 3, 0}} },           -- 109/119 RUN Reforged Empyrean. Set Bonus: Occasionally absorbs damage taken. Adds 2% activation chance per piece
			 {id = 226, items = {26673, 26849, 27025, 27201, 27377},  matches = 2, matchType = matchtype.any, mods = {{tpz.mod.DOUBLE_ATTACK, 4, 2, 0}} },                                                 --  Argosy Armor Set +1 (+4-10% Double Attack)
			 {id = 227, items = {25618, 25691, 27122, 27307, 27478},  matches = 2, matchType = matchtype.any, mods = {{tpz.mod.CURE_POTENCY_II, 4, 2, 0}} },                                               --  Kaykaus Armor Set +1 (+4-10 Cure Potency II)
			 {id = 228, items = {26675, 26851, 27027, 27203, 27379},  matches = 2, matchType = matchtype.any, mods = {{tpz.mod.MARTIAL_ARTS, 8, 4, 0}} },                                                  --  Rao Armor Set +1 (+8-20 Martial Arts)
		}
...
--		printf("gear_sets.cpp HandleHipsterSet SEXY BEAST SET\n")
		...
		player:addGearSetMod(gearset.id + 2, tpz.mod.STR, modValue / 3)
        return
    end
end
