...
local GearSets =  {
             ...
             {id = 74, items = {26920, 26921, 27434, 27259, 27260, 26762, 26763, 27074, 27075, 27433}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ZANSHIN_DOUBLE_DAMAGE, extraDamageChance, 0, 0}} },    -- 109/119 SAM AF3
             {id = 75, items = {27414, 27413, 27240, 27239, 27055, 27054, 26901, 26900, 26743, 26742}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.EXTRA_KICK_ATTACK, extraAttackChance, 0, 0}} },        -- 109/119 MNK AF3
			 ...
			 {id = 215, items = {26748, 26906, 27060, 27245, 27419, 26749, 26907, 27061, 27246, 27420}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.AUGMENT_COMPOSURE, 25, 10, 0}} },         -- 109/119 RDM Reforged Empyrean. Set Bonus: Augments "Composure". Increases the duration of enhancing magic when cast on other people
			 ...
			 {id = 224, items = {26782, 26940, 27094, 27279, 27453, 26783, 26941, 27095, 27280, 27454}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ABSORB_DMG_CHANCE, 4, 2, 0}} },           -- 109/119 RUN Reforged Empyrean. Set Bonus: Occasionally absorbs damage taken. Adds 2% activation chance per piece
