...
local GearSets =  {
			 ...
			 {id = 224, items = {26782, 26940, 27094, 27279, 27453, 26783, 26941, 27095, 27280, 27454}, matches = 2, matchType = matchtype.any, mods = {{tpz.mod.ABSORB_DMG_CHANCE, 6, 3, 0}} },           -- 109/119 RUN Reforged Empyrean. Set Bonus: Occasionally absorbs damage taken. Adds 2% activation chance per piece
			 {id = 225, items = {26673, 26849, 27025, 27201, 27377},  matches = 2, matchType = matchtype.any, mods = {{tpz.mod.DOUBLE_ATTACK, 4, 2, 0}} },                                                 --  Argosy Armor Set +1 (+4-10% Double Attack)
			 {id = 226, items = {25618, 25691, 27122, 27307, 27478},  matches = 2, matchType = matchtype.any, mods = {{tpz.mod.CURE_POTENCY_II, 4, 2, 0}} },                                               --  Kaykaus Armor Set +1 (+4-10 Cure Potency II)
			 {id = 227, items = {26675, 26851, 27027, 27203, 27379},  matches = 2, matchType = matchtype.any, mods = {{tpz.mod.MARTIAL_ARTS, 8, 4, 0}} },                                                  --  Rao Armor Set +1 (+8-20 Martial Arts)
		}
