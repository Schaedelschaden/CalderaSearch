...
function onUseAbility(player,target,ability)
	...
	-- printf("light_maneuver.lua onUseAbility PLAYER: [%s]  CURRENT BURDEN: [%i] THRESHOLD: [%i]  OVERLOAD CHANCE: [%i] ROLL: [%i]", player:getName(), currentBurden, threshold, overloadChance, roll)
