...
function onAbilityCheck(player, target, ability)
	...
	local cost = 10 -- Set the Blood Pact MP Cost here
...
--		printf("Rock Throw PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Rock Throw PET onAbilityCheck\n")
