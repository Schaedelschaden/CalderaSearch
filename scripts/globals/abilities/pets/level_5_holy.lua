---------------------------------------------
-- Level 5 Holy (Cait Sith Blood Pact)
---------------------------------------------
...
--		printf("LeveL 5 Holy PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Level 5 Holy PET onAbilityCheck\n")
...
--	printf("Level 5 Holy PET onPetAbility\n")
