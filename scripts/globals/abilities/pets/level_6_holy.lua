---------------------------------------------
-- Level 6 Holy (Cait Sith Blood Pact)
---------------------------------------------
...
--		printf("LeveL 6 Holy PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Level 6 Holy PET onAbilityCheck\n")
...
--	printf("Level 6 Holy PET onPetAbility\n")
	...
	if (moblevel % 6 == 0) then -- Divides moblevel by 6 then checks if there is any remainder
