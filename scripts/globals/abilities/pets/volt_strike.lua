...
function onAbilityCheck(player, target, ability)
	...
	local cost = 229 -- Set the Blood Pact MP Cost here
...
--		printf("Volt Strike PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Volt Strike PET onAbilityCheck\n")
