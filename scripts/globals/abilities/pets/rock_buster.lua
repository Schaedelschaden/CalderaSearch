...
function onAbilityCheck(player, target, ability)
	...
	local cost = 39 -- Set the Blood Pact MP Cost here
...
--		printf("Rock Buster PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Rock Buster PET onAbilityCheck\n")
