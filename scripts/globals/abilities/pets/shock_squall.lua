...
function onAbilityCheck(player, target, ability)
	...
	local cost = 67 -- Set the Blood Pact MP Cost here
...
--		printf("Shock Squall PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Shock Squall PET onAbilityCheck\n")
