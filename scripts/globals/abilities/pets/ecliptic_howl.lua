...
function onAbilityCheck(player, target, ability)
	...
	local cost = 57 -- Set the Blood Pact MP Cost here
...
--		printf("Ecliptic Howl PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Ecliptic Howl PET onAbilityCheck\n")
