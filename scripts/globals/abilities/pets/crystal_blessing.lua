---------------------------------------------
-- Crystal Blessing (Shiva Blood Pact)
---------------------------------------------
...
function onAbilityCheck(player, target, ability)
	...
	local cost = 201 -- Set the Blood Pact MP Cost here
...
--		printf("Crystal Blessing PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Crystal Blessing PET onAbilityCheck\n")
...
function onPetAbility(target, pet, skill, summoner)
	...
	target:addStatusEffect(tpz.effect.STORE_TP, 225, 0, duration)
end