...
--		printf("Fire IV (BP) PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Fire IV (BP) PET onAbilityCheck\n")
...
function onPetAbility(target, pet, skill)
    ...
    local damage = math.floor(650 + 0.025*(tp))
