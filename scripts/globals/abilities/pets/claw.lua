...
function onAbilityCheck(player, target, ability)
	...
	local cost = 7 -- Set the Blood Pact MP Cost here
...
--		printf("Claw PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Claw PET onAbilityCheck\n")
