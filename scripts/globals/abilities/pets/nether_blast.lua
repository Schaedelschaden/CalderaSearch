---------------------------------------------
-- Nether Blast (Diabolos Blood Pact)
---------------------------------------------
...
function onAbilityCheck(player, target, ability)
	...
	local cost = 109 -- Set the Blood Pact MP Cost here
...
--		printf("Nether Blast PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Nether Blast PET onAbilityCheck\n")
