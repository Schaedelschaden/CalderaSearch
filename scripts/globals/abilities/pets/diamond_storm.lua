---------------------------------------------
-- Diamond Storm (Shiva Blood Pact)
---------------------------------------------
...
--		printf("Diamond Storm PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Diamond Storm PET onAbilityCheck\n")
...
function onPetAbility(target, pet, skill, summoner)
	...
	target:addStatusEffect(tpz.effect.EVASION_DOWN, 75, 0, duration)
