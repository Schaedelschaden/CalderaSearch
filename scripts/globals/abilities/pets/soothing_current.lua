...
function onAbilityCheck(player, target, ability)
	...
	local cost = 95 -- Set the Blood Pact MP Cost here
...
--		printf("Soothing Current PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Soothing Current PET onAbilityCheck\n")
