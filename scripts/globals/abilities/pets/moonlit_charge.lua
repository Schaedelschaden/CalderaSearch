...
function onAbilityCheck(player, target, ability)
	...
	local cost = 17 -- Set the Blood Pact MP Cost here
...
--		printf("Moonlit Charge PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Moonlit Charge PET onAbilityCheck\n")
