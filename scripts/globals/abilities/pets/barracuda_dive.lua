...
function onAbilityCheck(player, target, ability)
	...
	local cost = 8 -- Set the Blood Pact MP Cost here
...
--		printf("Barracuda Dive PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Barracuda Dive PET onAbilityCheck\n")
