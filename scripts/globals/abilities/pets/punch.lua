...
function onAbilityCheck(player, target, ability)
	...
	local cost = 9 -- Set the Blood Pact MP Cost here
...
--		printf("Punch PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Punch PET onAbilityCheck\n")
