...
function onAbilityCheck(player, target, ability)
	...
	local cost = 80 -- Set the Blood Pact MP Cost here
...
--		printf("Reraise II PET onAbilityCheck BLOOD BOON COST REDUCTION [%i to %i]\n",originalcost,cost)
	end
	
	player:setMP(currentMP - cost)
	
--	printf("Reraise II PET onAbilityCheck\n")
