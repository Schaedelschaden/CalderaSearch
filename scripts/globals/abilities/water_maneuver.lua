...
function onUseAbility(player,target,ability)
    ...
    local currentBurden = target:addBurden(tpz.magic.ele.WATER-1, burden)
	...
	-- printf("water_maneuver.lua onUseAbility PLAYER: [%s]  CURRENT BURDEN: [%i] THRESHOLD: [%i]  OVERLOAD CHANCE: [%i] ROLL: [%i]", player:getName(), currentBurden, threshold, overloadChance, roll)
