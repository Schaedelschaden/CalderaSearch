...
function onEffectGain(target, effect)
	...
	-- target:addMod(tpz.mod.SDT_PHYS, power)
    -- target:addMod(tpz.mod.SDT_RANGED, power)
    -- target:addMod(tpz.mod.SDT_MAGIC, power)
    -- target:addMod(tpz.mod.SDT_BREATH, power)
end
...
function onEffectLose(target, effect)
	...
	-- target:delMod(tpz.mod.SDT_PHYS, power)
    -- target:delMod(tpz.mod.SDT_RANGED, power)
    -- target:delMod(tpz.mod.SDT_MAGIC, power)
    -- target:delMod(tpz.mod.SDT_BREATH, power)
end